...
class TestCustomList(unittest.TestCase):
    ...
    def test_add_with_int(self):
        ...
        self.assertEqual(custom_list, original)  # Проверка неизменности
    ...
    def test_add_with_list(self):
        ...
        self.assertEqual(custom_list, original_custom)  # Проверка неизменности
        self.assertEqual(other_list, original_other)  # Проверка неизменности
    ...
    def test_eq(self):
        ...
        self.assertEqual(custom_list1, original1)  # Проверка неизменности
        self.assertEqual(custom_list2, original2)  # Проверка неизменности
    ...
    def test_add_different_sizes(self):
        ...
        self.assertEqual(custom_list, origiginal)  # Проверка неизменности
    ...
    def test_sub_different_sizes(self):
        ...
        other_list = [5, 3, 1]
        result = custom_list - other_list
        self.assertEqual(result, CustomList([5, 5, -1]))
        self.assertEqual(custom_list, original)  # Проверка неизменности
        ...
        other_list = [5]
        result = custom_list - other_list
        self.assertEqual(result, CustomList([5, 8, 6]))
        self.assertEqual(custom_list, original)  # Проверка неизменности
